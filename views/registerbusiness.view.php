    ...
    <div class="row mb-3">
        ...
        <div class="col-8">
            <div class="card changeaccount ">
                <h2 class="card-title ms-1">Bedrijfs account registreren</h2>
                <div class="card-body">
                    <form action="<?=Request::buildUri("/registreren-bedrijven")?>" method="POST">
                    ...
                    <a href="<?=Request::buildUri("/registreren")?>" class="text-danger">Particulier account registreren?</a>
                    <br>
